...
public class ScoringFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            while (recordCursor.moveToNext()) {
                ...
                try{
                    ...
                    if((record.is_scored()!=true)&&(record_json.getBoolean("draft")==true)
                        ...
                        if(record_indicator.is_text_only()){
        ...
        //remove text only indicators so they don't get displayed
        for(Indicator i : text_only_indicators) {
            indicators.remove(i);
        }
