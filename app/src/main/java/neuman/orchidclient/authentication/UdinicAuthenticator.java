...
public class UdinicAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        // return an error
        if (!authTokenType.equals(neuman.orchidclient.authentication.AccountGeneral.AUTHTOKEN_TYPE_READ_ONLY) && !authTokenType.equals(neuman.orchidclient.authentication.AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS)) {
